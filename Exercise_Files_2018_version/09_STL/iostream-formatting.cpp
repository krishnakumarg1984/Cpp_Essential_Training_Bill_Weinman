...
int main() {
  ...
  */
  ...
  cout << "octal with showbase: " << oct << i1 << ' ' << i2 << ' ' << i3
       << endl;
  cout << "octal with noshowbase: " << noshowbase << oct << i1 << ' ' << i2
       << ' ' << i3 << endl;  // DO NOT use this one. Really confusing!
  ...
  cout << "fixed: " << fixed << d1 << ' ' << d2 << ' ' << d3 << ' '
       << endl;  // by default, fixed sets 6 digits to the right of the decimal
                 // point
  cout << "scientific: " << scientific << d1 << ' ' << d2 << ' ' << d3 << ' '
       << endl;
  cout << "fixed (3): " << setprecision(3) << fixed << d1 << ' ' << d2 << ' '
       << d3 << ' ' << endl;
  cout << "scientific (7): " << setprecision(7) << scientific << d1 << ' ' << d2
       << ' ' << d3 << ' ' << endl;
